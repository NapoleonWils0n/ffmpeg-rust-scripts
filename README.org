...
Statically Compiled Binaries: Provided for NixOS, Linux, Windows and MacOS

These are standalone executables that do not require a Rust runtime to be installed on your system.

Manual Compilation: For FreeBSD, you will need to install the Rust toolchain and compile the scripts from source to ensure compatibility with your specific system architecture.
...
#+BEGIN_SRC sh
sudo pkg install ffmpeg yt-dlp deno fd-find git
#+END_SRC
