...
#+begin_src sh
sha256sum -c nixos-ffmpeg-rust-scripts-v3.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: nixos-ffmpeg-rust-scripts-v3.tar.gz: OK
#+end_example

***** Extract the archive

Note: Replace v3 with the actual version number you downloaded.

#+begin_src sh
tar -xf nixos-ffmpeg-rust-scripts-v3.tar.gz
#+end_src
...
#+begin_src sh
mv nixos-ffmpeg-rust-scripts-v3/* ~/bin/
#+end_src
...
#+begin_src sh
sha256sum -c linux-ffmpeg-rust-scripts-v3.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: linux-ffmpeg-rust-scripts-v3.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf linux-ffmpeg-rust-scripts-v3.tar.gz
#+end_src
...
#+begin_src sh
mv linux-ffmpeg-rust-scripts-v3/* ~/bin/
#+end_src
...
#+begin_src sh
cat .\windows-ffmpeg-rust-scripts-v3.zip.sha256
#+end_src

2. Calculate the actual hash

#+begin_src sh
Get-FileHash .\windows-ffmpeg-rust-scripts-v3.zip -Algorithm SHA256
#+end_src
...
#+begin_src sh
sha256sum -c windows-ffmpeg-rust-scripts-v3.zip.sha256
#+end_src
...
Note: In the steps below, replace "v3" with the specific version number of the release you downloaded (e.g., v0.3.0).

1) Right-click the downloaded windows-ffmpeg-rust-scripts-v3.zip.
2) Select Properties.
...
1) Right-click the windows-ffmpeg-rust-scripts-v3.zip file and select Extract All.
...
#+begin_src sh
shasum -a 256 -c mac-ffmpeg-rust-scripts-v3.zip.sha256
#+end_src

#+begin_example
Expected Output: mac-ffmpeg-rust-scripts-v3.zip: OK
#+end_example
...
#+begin_src sh
unzip mac-ffmpeg-rust-scripts-v3.zip
#+end_src
...
#+begin_src sh
mv mac-ffmpeg-rust-scripts-v3/* ~/bin/
#+end_src
...
#+begin_src sh
sha256sum -c freebsd-ffmpeg-rust-scripts-v3.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: freebsd-ffmpeg-rust-scripts-v3.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf freebsd-ffmpeg-rust-scripts-v3.tar.gz
#+end_src
...
#+begin_src sh
mv freebsd-ffmpeg-rust-scripts-v3/* ~/bin/
#+end_src
...
Note: replace v3 with the release number in the examples below.

#+begin_src sh
mv build ffmpeg-rust-scripts-build-v3
#+end_src

Change into the ffmpeg-rust-scripts-build-v3 directory

#+begin_src sh
cd ffmpeg-rust-scripts-build-v3
#+end_src
...
#+begin_src sh
mv linux linux-ffmpeg-rust-scripts-v3
#+end_src

nixos

#+begin_src sh
mv nixos nixos-ffmpeg-rust-scripts-v3
#+end_src

windows

#+begin_src sh
mv windows windows-ffmpeg-rust-scripts-v3
#+end_src
...
#+begin_src sh
rm -i linux-ffmpeg-rust-scripts-v3/ffmpeg_rust_scripts
#+end_src

NixOS

#+begin_src sh
rm -i nixos-ffmpeg-rust-scripts-v3/ffmpeg_rust_scripts
#+end_src

Windows

#+begin_src sh
rm -i windows-ffmpeg-rust-scripts-v3/ffmpeg_rust_scripts.exe
#+end_src
...
#+begin_src sh
tar -czvf linux-ffmpeg-rust-scripts-v3.tar.gz linux-ffmpeg-rust-scripts-v3
#+end_src

***** nixos

#+begin_src sh
tar -czvf nixos-ffmpeg-rust-scripts-v3.tar.gz nixos-ffmpeg-rust-scripts-v3
#+end_src

***** windows

#+begin_src sh
zip -r windows-ffmpeg-rust-scripts-v3.zip windows-ffmpeg-rust-scripts-v3
#+end_src

**** create release-files directory

#+begin_src sh
mkdir -p release-files-v3
#+end_src

move the tar files and zip into the release-files directory

#+begin_src sh
mv *-ffmpeg-rust-scripts-v[0-9]*{.tar.gz,.zip} release-files-v3/
#+end_src
...
#+begin_src sh
sha256sum linux-ffmpeg-rust-scripts-v3.tar.gz > linux-ffmpeg-rust-scripts-v3.tar.gz.sha256
#+end_src

***** nixos

#+begin_src sh
sha256sum nixos-ffmpeg-rust-scripts-v3.tar.gz > nixos-ffmpeg-rust-scripts-v3.tar.gz.sha256
#+end_src

***** windows

#+begin_src sh
sha256sum windows-ffmpeg-rust-scripts-v3.zip > windows-ffmpeg-rust-scripts-v3.zip.sha256
#+end_src
