...
The lut-apply script lets you apply a lut created with the lut-create to a video to colour grade the footage.

You can also use ffmpeg compatable luts that are 512 x 512 pixels with the lut-apply script.
