...
#+begin_verse
scene-cut takes a cutlist created with scene-time script in the previous step,
and use it it to cut the video into clips based on the timestamps in the cutlist.
#+end_verse
