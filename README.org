...
#+begin_verse
trim-remote-clip trims online video supported by yt-dlp.
To change the quality of the clip downloaded you need to specify the options in your tr-dlp config file.
#+end_verse

#+begin_verse
the trim-remote-clip use's a start time with the -s option,
...
#+begin_src sh
trim-remote-clip -s 00:00:30 -i input.mp4 -t 00:01:30 -o clip.mp4
#+end_src
