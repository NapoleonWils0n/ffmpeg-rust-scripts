...
** nixos build binaries
*** nixos

project notes for buidling the binaries on nixos

**** create the build directory

create the build directory to copy the binaries into
